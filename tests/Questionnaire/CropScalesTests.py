...
def test_ask_to_crop_scale_constructor(ask_to_crop_scale):
...
def test_ask_to_crop_scales_btn(ask_to_crop_scale):
...
def test_crop_scales_constructor(crop_scales):
...
def test_crop_data(crop_scales):
