...
def test_ask_to_invert_scores_constructor(ask_to_invert_scores):
...
def test_ask_to_invert_scores_btn(ask_to_invert_scores):
...
def test_invert_scores_constructor(invert_scores):
...
def test_invert_scores_select_all_changed(invert_scores):
...
def test_invert_scores(invert_scores):
