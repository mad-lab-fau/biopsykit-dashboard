...
from tests.Questionnaire.QuestionnaireBaseMethodsForTesting import init_scores


@pytest.fixture
def ask_to_convert_scales():
...
def test_ask_to_convert_scales_constructor(ask_to_convert_scales):
...
def test_ask_to_convert_scales_btn_clicks(ask_to_convert_scales):
    assert ask_to_convert_scales is not None
...
def test_convert_scales_constructor(convert_scales):
...
def test_apply_questionnaire_scale_change(
    convert_scales, questionnaire_selector, input_offset
):
    assert convert_scales is not None
...
def test_apply_column_scale(convert_scales, column_selector, input_offset):
    assert convert_scales is not None
