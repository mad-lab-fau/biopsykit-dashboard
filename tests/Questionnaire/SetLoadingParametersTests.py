...
@pytest.fixture
def ask_to_set_loading_parameters():
    return AskToSetLoadingParameters()


@pytest.fixture
def set_loading_parameters():
    return SetLoadingParametersManually()


def test_ask_to_set_loading_parameters(ask_to_set_loading_parameters):
...
def test_clicking_buttons(ask_to_set_loading_parameters):
...
def test_setting_loading_parameters_manually(set_loading_parameters):
