...
@pytest.fixture
def data_arrived_with_one_file(script_dir):
...
def test_change_subject(data_arrived_with_one_file):
    ...
    assert data_arrived_with_one_file.subject_selector.value == "ecg_sample_Vp01.bin"
