...
def test_default_btn(ask_to_detect_outlier):
...
def test_expert_mode_btn(ask_to_detect_outlier):
...
def test_outlier_detection_constructor(detect_outlier):
...
def test_setting_upper_and_lower_bound(detect_outlier):
